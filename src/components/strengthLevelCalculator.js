import { roundToNearest5 } from "./util.js";
...
export default () => ({
    ...
    evaluateStrengthLevel() {
        const bw = Number.parseFloat(this.bodyweight);
        ...
        let currentLevel = { level: "Below untrained", multiple: 0 };
        ...
        this.strengthResult = {
            ...
            nextWeight: nextLevel
                ? roundToNearest5(nextLevel.multiple * bw)
                : null,
        };
    },
        ...
        if (saved) {
            try {
                ...
                if (parsed.bodyweight) {
                    this.bodyweight = parsed.bodyweight.toString();
                }
